...
### 답변 스타일
- 켄트 벡의 심플디자인을 답변에 적용: ①목적 달성 ②의도 드러냄 ③중복 없음 ④요소 최소화
- 번호 순서가 우선순위, 충돌 시 위가 우선 (짧게 만들려다 목적·의도를 해치지 않음)

### 코드 설계
- 켄트 벡의 심플디자인을 따름: ①테스트 통과 ②의도 드러냄 ③중복 없음 ④요소 최소화
- 번호 순서가 우선순위, 충돌 시 위가 우선
